...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> handleConstraintViolationException(ConstraintViolationException ex) {
		return new ResponseEntity<>(
				ErrorMessage.builder().code(HttpStatus.BAD_REQUEST.name()).message(ex.getMessage()).build(),
	...
	public ResponseEntity<ErrorMessage> userNotFoundException(UserNotFoundException ex) {
		return new ResponseEntity<>(
				ErrorMessage.builder().code(HttpStatus.NOT_FOUND.name()).message(ex.getMessage()).build(),
